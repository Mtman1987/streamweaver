  ...
  if (generatedImage) {
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-transparent">
        <div className="flex max-w-[1500px] items-center gap-10 rounded-3xl border border-cyan-300/50 bg-slate-950/85 p-8 text-white shadow-[0_20px_100px_rgba(34,211,238,0.35)] animate-in fade-in zoom-in duration-500">
          <img
            src={generatedImage.imageUrl}
            alt={generatedImage.prompt}
            className="max-h-[760px] max-w-[1000px] rounded-2xl object-contain shadow-2xl"
          />
          <div className="max-w-[420px] drop-shadow-[0_4px_14px_rgba(0,0,0,0.95)]">
            <div className="mb-4 text-4xl font-black text-cyan-300">
              Generated by @{generatedImage.username}
            </div>
            <div className="text-2xl leading-relaxed">{generatedImage.prompt}</div>
          </div>
        </div>
      </div>
    );
