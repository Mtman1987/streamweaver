    ...
    useEffect(() => {
        ...
        function connect() {
            ...
            ws.current.onopen = async () => {
                ...
                // Send identify message with user profile
                try {
                    ...
                    if (profileResponse.ok) {
                        ...
                        console.log('[WebSocket] Sent identify message with user profile');
                    }
                } catch (error) {
                    console.warn('[WebSocket] Failed to fetch user profile for identify:', error);
                }
