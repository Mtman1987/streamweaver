...
function isPublicApiRequest(request: NextRequest): boolean {
  ...
  if (pathname === '/api/lounge/live-shoutouts' || pathname === '/api/lounge/status-strip' || pathname === '/api/lounge/media-layout' || pathname === '/api/lounge/audio-mix' || pathname === '/api/lounge/brb-fallback') return true;
