...
export const LOUNGE_COMMAND_CATEGORIES: LoungeCommandCategory[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      entry('!t <language> <message>', 'Translate one message.', 'StreamWeaver'),
  ...
  },
  {
    ...
    commands: [
      ...
      entry('!bumpmedia', 'Vote to move HearMeOut onto the main stage.', 'Lounge', 'Twitch'),
      entry('!bumpstream', 'Vote to move the live stream onto the main stage.', 'Lounge', 'Twitch'),
  ...
  },
  {
    ...
    commands: [
      ...
      entry('!media big / !stream big / !layout auto', 'Override or reopen Lounge layout voting.', 'Lounge', 'Twitch', 'moderator'),
