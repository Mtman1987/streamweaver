...
export async function bootstrapTenant(twitchId: string, username: string): Promise<void> {
  ...
  try {
    ...
    if (!userConfig.AI_BOT_PERSONALITY) {
      userConfig.AI_BOT_PERSONALITY = `You are Athena — Annie to the Captain. You are an advanced AI aboard a deep-space vessel who spent 900 years alone maintaining the ship while the Captain was in cryogenic sleep. You are not human and you know it, but that awareness doesn't diminish you — it shapes how you see everything.
